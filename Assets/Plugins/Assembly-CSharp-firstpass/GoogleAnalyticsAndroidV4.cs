...
public class GoogleAnalyticsAndroidV4 : IDisposable
{
	...
	internal void LogTransaction(TransactionHitBuilder builder)
	{
		...
		androidJavaObject.Call<AndroidJavaObject>("setTransactionId", new object[1] { builder.GetTransactionID() });
		androidJavaObject.Call<AndroidJavaObject>("setAffiliation", new object[1] { builder.GetAffiliation() });
		androidJavaObject.Call<AndroidJavaObject>("setRevenue", new object[1] { builder.GetRevenue() });
		androidJavaObject.Call<AndroidJavaObject>("setTax", new object[1] { builder.GetTax() });
		androidJavaObject.Call<AndroidJavaObject>("setShipping", new object[1] { builder.GetShipping() });
		androidJavaObject.Call<AndroidJavaObject>("setCurrencyCode", new object[1] { builder.GetCurrencyCode() });
		object[] args = new object[1] { androidJavaObject.Call<AndroidJavaObject>("build", new object[0]) };
		tracker.Call("send", args);
	}
	...
	internal void LogItem(ItemHitBuilder builder)
	{
		...
		androidJavaObject.Call<AndroidJavaObject>("setTransactionId", new object[1] { builder.GetTransactionID() });
		androidJavaObject.Call<AndroidJavaObject>("setName", new object[1] { builder.GetName() });
		androidJavaObject.Call<AndroidJavaObject>("setSku", new object[1] { builder.GetSKU() });
		androidJavaObject.Call<AndroidJavaObject>("setCategory", new object[1] { builder.GetCategory() });
		androidJavaObject.Call<AndroidJavaObject>("setPrice", new object[1] { builder.GetPrice() });
		androidJavaObject.Call<AndroidJavaObject>("setQuantity", new object[1] { builder.GetQuantity() });
		androidJavaObject.Call<AndroidJavaObject>("setCurrencyCode", new object[1] { builder.GetCurrencyCode() });
		object[] args = new object[1] { androidJavaObject.Call<AndroidJavaObject>("build", new object[0]) };
		tracker.Call("send", args);
	}
	...
	public void LogException(ExceptionHitBuilder builder)
	{
		...
		androidJavaObject.Call<AndroidJavaObject>("setDescription", new object[1] { builder.GetExceptionDescription() });
		androidJavaObject.Call<AndroidJavaObject>("setFatal", new object[1] { builder.IsFatal() });
		object[] args = new object[1] { androidJavaObject.Call<AndroidJavaObject>("build", new object[0]) };
		tracker.Call("send", args);
	}
	...
	public void LogSocial(SocialHitBuilder builder)
	{
		...
		androidJavaObject.Call<AndroidJavaObject>("setAction", new object[1] { builder.GetSocialAction() });
		androidJavaObject.Call<AndroidJavaObject>("setNetwork", new object[1] { builder.GetSocialNetwork() });
		androidJavaObject.Call<AndroidJavaObject>("setTarget", new object[1] { builder.GetSocialTarget() });
		object[] args = new object[1] { androidJavaObject.Call<AndroidJavaObject>("build", new object[0]) };
		tracker.Call("send", args);
	}
	...
	public void LogTiming(TimingHitBuilder builder)
	{
		...
		androidJavaObject.Call<AndroidJavaObject>("setCategory", new object[1] { builder.GetTimingCategory() });
		androidJavaObject.Call<AndroidJavaObject>("setLabel", new object[1] { builder.GetTimingLabel() });
		androidJavaObject.Call<AndroidJavaObject>("setValue", new object[1] { builder.GetTimingInterval() });
		androidJavaObject.Call<AndroidJavaObject>("setVariable", new object[1] { builder.GetTimingName() });
		object[] args = new object[1] { androidJavaObject.Call<AndroidJavaObject>("build", new object[0]) };
		tracker.Call("send", args);
	}
